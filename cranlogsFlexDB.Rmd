...
renderPlotly({
 df %>% 
   ...
   plot_ly(x=date,y=tot/100,markers="lines", name="Cumulative (100m)") %>% 
   layout(title="",
          xaxis=list(title=""),
          yaxis=list(title="",rangemode="tozero")) %>% 
   add_trace(x=date,y=daily,mode="bar",opacity=0.5, name="Daily Download")
...
allByDay %>% 
    plot_ly(x=date,y=tot/1000,markers="lines", name="Cumulative ('000") %>% 
   layout(title="",
          xaxis=list(title=""),
          yaxis=list(title="Total Packages",rangemode="tozero")) %>% 
   add_trace(x=date,y=n,mode="bar",opacity=0.5, name="New daily")
